...
```
curl -LO raw.githubusercontent.com/Techcps/Google-Cloud-Skills-Boost/master/Configuring%20IAM%20Permissions%20with%20gcloud/techcps647.sh
sudo chmod +x techcps647.sh
./techcps647.sh
```
