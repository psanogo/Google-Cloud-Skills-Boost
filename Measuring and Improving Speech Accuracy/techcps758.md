...
```
curl -LO raw.githubusercontent.com/Techcps/Google-Cloud-Skills-Boost/master/Measuring%20and%20Improving%20Speech%20Accuracy/techcps758.sh
sudo chmod +x techcps758.sh
./techcps758.sh
```
