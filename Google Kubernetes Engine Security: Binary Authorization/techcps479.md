...
```
curl -LO raw.githubusercontent.com/Techcps/Google-Cloud-Skills-Boost/master/Google%20Kubernetes%20Engine%20Security%3A%20Binary%20Authorization/techcps479.sh
sudo chmod +x techcps479.sh
./techcps479.sh
```
