...
bq --location=US --dataset mk gemini_demo
    ...
    (
      SELECT
        ...
        CONCAT(
          ...
          review_text,
          ' In your response do not include the sentiment explanation. Remove all extraneous information from your response; it should be a boolean response, either positive or negative.'
        ) AS prompt
