...
```
curl -LO raw.githubusercontent.com/Techcps/Google-Cloud-Skills-Boost/master/Using%20gsutil%20to%20Perform%20Operations%20on%20Buckets%20and%20Objects/techcps130.sh
sudo chmod +x techcps130.sh
./techcps130.sh
```
---
```
