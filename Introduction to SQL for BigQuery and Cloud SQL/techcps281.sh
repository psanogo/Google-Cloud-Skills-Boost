...
curl -O https://github.com/Techcps/Google-Cloud-Skills-Boost/blob/main/Introduction%20to%20SQL%20for%20BigQuery%20and%20Cloud%20SQL/start_station_data.csv

curl -O https://github.com/Techcps/Google-Cloud-Skills-Boost/blob/main/Introduction%20to%20SQL%20for%20BigQuery%20and%20Cloud%20SQL/end_station_data.csv
