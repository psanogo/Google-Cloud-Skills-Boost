...
curl -LO raw.githubusercontent.com/Techcps/Google-Cloud-Skills-Boost/master/Creating%20PDFs%20with%20Go%20and%20Cloud%20Run/server.go

go build -o server

curl -LO raw.githubusercontent.com/Techcps/Google-Cloud-Skills-Boost/master/Creating%20PDFs%20with%20Go%20and%20Cloud%20Run/Dockerfile
